...
class service_docs(nodes.General, nodes.Element):
    pass
...
def service_docs_html(self, node):
    # This method renders containers per each service of the category with all
    # links as individual list items
    data = '<div class="row row-cols-1 row-cols-md-3 g-4">'
    service = {
...
def setup(app):
    ...
    app.add_node(service_docs,
                 html=(service_docs_html, None))
    ...
    app.add_directive("service_docs", ServiceDocs)
